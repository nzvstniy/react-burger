...
import { SHOW_INGREDIENT_DETAILS } from '../../services/reducer-selector-directory/currentIngredient/current-ingredient-reducer';


function IngredientDetails({ isPageSingle = false }) {
